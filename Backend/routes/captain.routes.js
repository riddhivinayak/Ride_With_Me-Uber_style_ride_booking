...
router.get('/profile', authMiddleware.authcaptainToken, captainController.getCaptainProfile)

router.get('/logout', authMiddleware.authcaptainToken, captainController.logoutCaptain)
